...
public class EmployeeServiceImpl implements EmployeeService {
	...
	private static List<Employee> employeeArray = new ArrayList<Employee>(Arrays.asList(
			new Employee(1, "dia", "jam", "birzeit-uni street", 7000, "ScD", WorkingField.Owner, "23123213", 7,
					"1/4/2015", "123456789"),
			new Employee(2, "moh", "sa", "ramallah-safd street", 4220, "M.D", WorkingField.Worker, "3123524", 5,
					"23/4/2018", "123456789"),
			new Employee(3, "geha", "fadal", "nablus-hos street", 3700, "M.D", WorkingField.Worker, "6754646", 3,
					"3/2/2017", "123456789"),
			new Employee(4, "abd", "qar", "safad-safd street", 3000, " B.E", WorkingField.Admin, "3123524", 2,
					"23/4/2017", "123456789"),
			new Employee(5, "moh", "sa", "ramallah-safd street", 2700, "B.Res.Ec.", WorkingField.Admin, "3123524", 2,
					"23/4/2018", "123456789")));
