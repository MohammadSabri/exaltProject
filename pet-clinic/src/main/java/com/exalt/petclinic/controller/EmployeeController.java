...
public class EmployeeController {
	...
	@PostMapping(path = {"/api/v1/owner/worker","/api/v1/admin/worker"}, consumes = "application/json", produces = "application/json")
	...
	@PutMapping(path = { "/api/v1/owner/admin/{id}","/api/v1/owner/worker/{id}"}, consumes = "application/json", produces = "application/json")
